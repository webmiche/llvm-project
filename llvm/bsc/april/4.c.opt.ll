...
define dso_local i32 @foo(i32* writeonly %0, i32* writeonly %1, %struct.Point* nocapture readnone %2) local_unnamed_addr #0 {
  store i32 5, i32* %0, align 4, !tbaa !3
  store i32 10, i32* %1, align 4, !tbaa !3
  %4 = icmp eq i32* %1, %0
  %.1 = select i1 %4, i32 -1, i32 5
  ret i32 %.1
}

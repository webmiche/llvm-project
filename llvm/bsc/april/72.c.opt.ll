...
define dso_local i32 @foo(i32* %0, i32* nocapture writeonly %1, i32* nocapture %2, i32* nocapture writeonly %3) local_unnamed_addr #0 !dbg !12 {
  ...
  br i1 %5, label %11, label %6, !dbg !36

6:                                                ; preds = %4
  %7 = load i32, i32* %0, align 4, !dbg !37, !tbaa !29
  call void @llvm.dbg.value(metadata i32 %7, metadata !21, metadata !DIExpression()), !dbg !27
  %8 = icmp eq i32 %7, 5, !dbg !38
  store i32 50, i32* %2, align 4, !dbg !39, !tbaa !29
  store i32 100, i32* %3, align 4, !dbg !39, !tbaa !29
  br i1 %8, label %9, label %11, !dbg !40

9:                                                ; preds = %6
  %10 = load i32, i32* %2, align 4, !dbg !41, !tbaa !29
  call void @llvm.dbg.value(metadata i32 %10, metadata !22, metadata !DIExpression()), !dbg !42
  br label %11

11:                                               ; preds = %6, %9, %4
  %.1 = phi i32 [ 0, %4 ], [ %10, %9 ], [ 50, %6 ], !dbg !27
  ret i32 %.1, !dbg !43
}
...
!37 = !DILocation(line: 10, column: 15, scope: !12)
!38 = !DILocation(line: 12, column: 13, scope: !24)
!39 = !DILocation(line: 0, scope: !24)
!40 = !DILocation(line: 12, column: 9, scope: !12)
!41 = !DILocation(line: 18, column: 20, scope: !23)
!42 = !DILocation(line: 0, scope: !23)
!43 = !DILocation(line: 29, column: 1, scope: !12)

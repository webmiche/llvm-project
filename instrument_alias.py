...
class InstrumentAlias:
    ...
    def run_step_single_func(
        ...
        for line in p.stderr.split("\n"):
            if line.__contains__("relaxable AA queries"):
                return int(line.split("aa")[0].strip())
    ...
    def maximal_relaxation(
        ...
        for f in files:
            count_per_file[f] = self.run_step_single_func(f, 0, [], None, False)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        default="/home/michel/ETH/AST/llvm-project/build_new_instr/bin",
    )

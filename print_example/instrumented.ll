...
define noundef i1 @foo() local_unnamed_addr {
  %1 = tail call ptr @fopen(ptr nonnull @2, ptr nonnull @3)
  tail call void (ptr, ...) @fprintf(ptr %1, ptr nonnull @0, i1 false)
  ret i1 false
}

define noundef i32 @bat() local_unnamed_addr {
  %1 = tail call ptr @fopen(ptr nonnull @2, ptr nonnull @3)
  tail call void (ptr, ...) @fprintf(ptr %1, ptr nonnull @1, i32 0)
  ret i32 0
}
...
define noundef i32 @baz() local_unnamed_addr {
  ...
  tail call void (ptr, ...) @fprintf(ptr %0, ptr nonnull @0, i1 false)
  %1 = tail call ptr @fopen(ptr nonnull @2, ptr nonnull @3)
  tail call void (ptr, ...) @fprintf(ptr %1, ptr nonnull @4, i32 5)
  ret i32 5
}
...
define noundef i32 @qux() local_unnamed_addr {
  ...
  %0 = tail call ptr @fopen(ptr nonnull @2, ptr nonnull @3)
  tail call void (ptr, ...) @fprintf(ptr %0, ptr nonnull @1, i32 0)
  ret i32 5
}
...
define noundef i32 @quuz() local_unnamed_addr {
  ...
  tail call void (ptr, ...) @fprintf(ptr %2, ptr nonnull @1, i32 0)
  ret i32 5
}

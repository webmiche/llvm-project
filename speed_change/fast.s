...
# %bb.35:                               # %if.then48.i
	...
	jmp	.LBB20_32
.LBB20_36:                              # %if.end107
	movsd	%xmm4, 360(%rsp)                # 8-byte Spill
...
.LBB20_62:                              # %if.end112.i
	...
	movsd	152(%rsp), %xmm7                # 8-byte Reload
                                        # xmm7 = mem[0],zero
...
# %bb.71:                               # %if.then166.i
	...
	addsd	%xmm3, %xmm8
	movsd	%xmm8, 16(%rsp)                 # 8-byte Spill
...
# %bb.88:                               # %for.body305.lr.ph.i
	...
	movsd	8(%rsp), %xmm4                  # 8-byte Reload
                                        # xmm4 = mem[0],zero
.LBB20_89:                              # %for.cond312.preheader.i
	movq	%r12, %r14
	jmp	.LBB20_91
.LBB20_90:
	movsd	%xmm0, 120(%rsp)                # 8-byte Spill
	...
	movsd	8(%rsp), %xmm4                  # 8-byte Reload
                                        # xmm4 = mem[0],zero
	movq	104(%rsp), %rbx                 # 8-byte Reload
.LBB20_91:                              # %for.cond312.preheader.i
	movq	prm(%rip), %rax
	cmpl	$0, 96(%rax)
	movq	%r14, 408(%rsp)                 # 8-byte Spill
	js	.LBB20_130
# %bb.92:                               # %for.body316.i.preheader
	movq	$-1, %rcx
	.p2align	4, 0x90
.LBB20_93:                              # %for.body316.i
                                        # =>This Inner Loop Header: Depth=1
	...
	cmpq	%rdx, %rcx
	jl	.LBB20_93
# %bb.94:                               # %for.cond323.preheader.i
	testl	%edx, %edx
	jle	.LBB20_130
# %bb.95:                               # %for.body327.i.preheader
	xorl	%r14d, %r14d
	xorpd	%xmm0, %xmm0
	movsd	%xmm0, 16(%rsp)                 # 8-byte Spill
	...
	jmp	.LBB20_98
	.p2align	4, 0x90
.LBB20_96:                              #   in Loop: Header=BB20_98 Depth=1
	movapd	%xmm1, %xmm0
.LBB20_97:                              # %for.inc590.i
...
.LBB20_98:                              # %for.body327.i
	...
	movq	frozen(%rip), %rax
	cmpl	$0, (%rax,%r14,4)
	movsd	%xmm6, 136(%rsp)                # 8-byte Spill
...
# %bb.99:                               # %if.then335.i
	...
	mulsd	%xmm1, %xmm0
	callq	exp@PLT
	movsd	136(%rsp), %xmm6                # 8-byte Reload
                                        # xmm6 = mem[0],zero
	movq	(%rsp), %r9                     # 8-byte Reload
	movsd	8(%rsp), %xmm4                  # 8-byte Reload
                                        # xmm4 = mem[0],zero
...
.LBB20_100:                             # %if.end357.i
                                        #   in Loop: Header=BB20_98 Depth=1
	movslq	(%r13,%r14,4), %rax
...
.LBB20_103:                             # %if.end379.i
	...
	cmpl	$0, (%rsi,%r14,4)
	jle	.LBB20_106
# %bb.104:                              # %for.body389.i.preheader
                                        #   in Loop: Header=BB20_98 Depth=1
	movq	IexclAt(%rip), %rdx
	movq	(%rdx,%r14,8), %rdx
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB20_105:                             # %for.body389.i
...
.LBB20_110:                             # %if.end417.i
	...
	subpd	%xmm0, %xmm2
	movslq	%ebp, %rbx
	movsd	464(%rsp), %xmm3                # 8-byte Reload
                                        # xmm3 = mem[0],zero
...
.LBB20_112:                             # %if.end445.i
	...
	mulsd	256(%rsp), %xmm0                # 8-byte Folded Reload
	addsd	272(%rsp), %xmm0                # 8-byte Folded Reload
	ucomisd	.LCPI20_35(%rip), %xmm0
	jb	.LBB20_114
# %bb.113:                              #   in Loop: Header=BB20_108 Depth=2
	sqrtsd	%xmm0, %xmm0
	jmp	.LBB20_115
	.p2align	4, 0x90
.LBB20_114:                             # %call.sqrt36
                                        #   in Loop: Header=BB20_108 Depth=2
	callq	sqrt@PLT
.LBB20_115:                             # %if.end445.i.split
                                        #   in Loop: Header=BB20_108 Depth=2
	movsd	.LCPI20_4(%rip), %xmm1          # xmm1 = mem[0],zero
	divsd	%xmm0, %xmm1
	...
	addsd	256(%rsp), %xmm2                # 8-byte Folded Reload
	mulsd	%xmm1, %xmm2
	movq	egb.sumdeijda(%rip), %rax
	movsd	136(%rsp), %xmm6                # 8-byte Reload
                                        # xmm6 = mem[0],zero
	...
	cmpq	%rax, %r14
	jne	.LBB20_117
# %bb.116:                              #   in Loop: Header=BB20_108 Depth=2
	movsd	8(%rsp), %xmm4                  # 8-byte Reload
                                        # xmm4 = mem[0],zero
	movq	(%rsp), %r9                     # 8-byte Reload
	jmp	.LBB20_122
	.p2align	4, 0x90
.LBB20_117:                             # %if.then492.i
                                        #   in Loop: Header=BB20_108 Depth=2
	ucomisd	.LCPI20_35(%rip), %xmm0
	jb	.LBB20_119
# %bb.118:                              #   in Loop: Header=BB20_108 Depth=2
	sqrtsd	%xmm0, %xmm0
	jmp	.LBB20_120
	.p2align	4, 0x90
.LBB20_119:                             # %call.sqrt37
                                        #   in Loop: Header=BB20_108 Depth=2
	movsd	%xmm9, 272(%rsp)                # 8-byte Spill
	movapd	%xmm10, 256(%rsp)               # 16-byte Spill
	callq	sqrt@PLT
	movapd	256(%rsp), %xmm10               # 16-byte Reload
	movsd	272(%rsp), %xmm9                # 8-byte Reload
                                        # xmm9 = mem[0],zero
	movsd	24(%rsp), %xmm8                 # 8-byte Reload
                                        # xmm8 = mem[0],zero
	movsd	152(%rsp), %xmm7                # 8-byte Reload
...
# %bb.121:                              # %if.then510.i
	...
	movsd	128(%rsp), %xmm5                # 8-byte Reload
                                        # xmm5 = mem[0],zero
	addsd	%xmm0, %xmm5
	movsd	%xmm5, 128(%rsp)                # 8-byte Spill
...
.LBB20_130:
	...
	movsd	%xmm0, 184(%rsp)                # 8-byte Spill
	movsd	%xmm0, 16(%rsp)                 # 8-byte Spill
.LBB20_131:                             # %for.cond593.preheader.i
	movq	prm(%rip), %rax
	cmpl	$0, 96(%rax)
	jle	.LBB20_168
# %bb.132:                              # %for.body597.i.preheader
	movsd	.LCPI20_4(%rip), %xmm1          # xmm1 = mem[0],zero
...
.LBB20_134:                             # %for.inc894.i
	...
	cmpq	%rax, %r14
	jge	.LBB20_168
.LBB20_135:                             # %for.body597.i
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB20_144 Depth 2
	movq	frozen(%rip), %rax
	cmpl	$0, (%rax,%r14,4)
	jne	.LBB20_134
# %bb.136:                              # %for.body597.i
                                        #   in Loop: Header=BB20_135 Depth=1
	movq	%rbx, %rax
	movl	(%r13,%r14,4), %ebx
	addl	(%rax,%r14,4), %ebx
...
# %bb.140:                              # %if.then635.i
	...
	mulsd	%xmm1, %xmm3
	addsd	%xmm2, %xmm3
	movapd	288(%rsp), %xmm2                # 16-byte Reload
	mulsd	%xmm0, %xmm0
	movsd	.LCPI20_4(%rip), %xmm1          # xmm1 = mem[0],zero
	subsd	%xmm0, %xmm1
	movapd	304(%rsp), %xmm0                # 16-byte Reload
	mulsd	%xmm3, %xmm1
	mulsd	%xmm2, %xmm1
	divsd	(%r12,%r14,8), %xmm1
	mulsd	%xmm1, %xmm0
	movsd	.LCPI20_4(%rip), %xmm1          # xmm1 = mem[0],zero
.LBB20_141:                             # %for.body677.lr.ph.i
                                        #   in Loop: Header=BB20_135 Depth=1
	movapd	%xmm0, 304(%rsp)                # 16-byte Spill
	...
	movapd	%xmm2, %xmm0
	xorpd	.LCPI20_19(%rip), %xmm0
	movapd	%xmm0, 384(%rsp)                # 16-byte Spill
	movl	%ebx, %eax
...
.LBB20_142:                             # %for.inc864.i
	...
	movsd	.LCPI20_0(%rip), %xmm5          # xmm5 = mem[0],zero
.LBB20_143:                             # %for.inc864.i
                                        #   in Loop: Header=BB20_144 Depth=2
	incq	%r13
	cmpq	%r13, 152(%rsp)                 # 8-byte Folded Reload
	je	.LBB20_165
.LBB20_144:                             # %for.body677.i
...
.LBB20_146:                             # %if.end685.i
	...
	subpd	%xmm0, %xmm3
	movsd	256(%rsp), %xmm2                # 8-byte Reload
                                        # xmm2 = mem[0],zero
...
# %bb.149:                              # %if.end717.i
	...
	jb	.LBB20_151
# %bb.150:                              #   in Loop: Header=BB20_144 Depth=2
	xorps	%xmm0, %xmm0
	sqrtsd	%xmm8, %xmm0
	jmp	.LBB20_152
	.p2align	4, 0x90
.LBB20_151:                             # %call.sqrt38
                                        #   in Loop: Header=BB20_144 Depth=2
	movapd	%xmm8, %xmm0
...
.LBB20_157:                             # %if.else765.i
                                        #   in Loop: Header=BB20_144 Depth=2
	movapd	288(%rsp), %xmm5                # 16-byte Reload
	movapd	%xmm5, %xmm0
	addsd	%xmm1, %xmm0
	ucomisd	%xmm0, %xmm2
	jbe	.LBB20_159
# %bb.158:                              # %if.then769.i
	...
	movapd	%xmm0, %xmm9
	mulsd	32(%rsp), %xmm9                 # 8-byte Folded Reload
	addsd	160(%rsp), %xmm9                # 8-byte Folded Reload
	jmp	.LBB20_163
...
# %bb.160:                              # %if.then786.i
	...
	divsd	%xmm2, %xmm0
	mulsd	%xmm6, %xmm7
	movsd	%xmm7, 192(%rsp)                # 8-byte Spill
	movapd	384(%rsp), %xmm4                # 16-byte Reload
	mulsd	%xmm5, %xmm4
	addsd	%xmm8, %xmm4
	addsd	%xmm3, %xmm4
	mulsd	.LCPI20_8(%rip), %xmm4
	...
	mulsd	%xmm2, %xmm4
	addsd	%xmm6, %xmm4
	movapd	%xmm4, 160(%rsp)                # 16-byte Spill
	mulsd	%xmm5, %xmm0
	callq	log@PLT
	movapd	160(%rsp), %xmm9                # 16-byte Reload
	movq	(%rsp), %r9                     # 8-byte Reload
	movsd	8(%rsp), %xmm4                  # 8-byte Reload
                                        # xmm4 = mem[0],zero
	mulsd	192(%rsp), %xmm0                # 8-byte Folded Reload
	subsd	%xmm0, %xmm9
...
# %bb.166:                              # %if.then886.i
	...
	jmp	.LBB20_133
	.p2align	4, 0x90
.LBB20_167:                             #   in Loop: Header=BB20_135 Depth=1
	movq	104(%rsp), %rbx                 # 8-byte Reload
	jmp	.LBB20_134
.LBB20_168:                             # %egb.exit114
...
# %bb.171:
	xorl	%esi, %esi
	jmp	.LBB20_174
.LBB20_172:                             # %for.body145.preheader.new
	andl	$-4, %edi
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB20_173:                             # %for.body145
                                        # =>This Inner Loop Header: Depth=1
	...
	cmpq	%rsi, %rdi
	jne	.LBB20_173
.LBB20_174:                             # %for.cond153.preheader.loopexit.unr-lcssa
	testq	%rdx, %rdx
	je	.LBB20_177
# %bb.175:                              # %for.body145.epil.preheader
	leaq	(%r9,%rsi,8), %rdi
	shlq	$3, %rsi
	addq	mme34.grad(%rip), %rsi
	xorl	%r8d, %r8d
	.p2align	4, 0x90
.LBB20_176:                             # %for.body145.epil
                                        # =>This Inner Loop Header: Depth=1
	...
	cmpq	%r8, %rdx
	jne	.LBB20_176
.LBB20_177:                             # %for.cond153.preheader
	movq	prm(%rip), %rdx
	movl	96(%rdx), %edi
	testl	%edi, %edi
	jle	.LBB20_185
# %bb.178:                              # %for.body157.lr.ph
	movq	frozen(%rip), %rax
	xorl	%edx, %edx
	xorpd	%xmm0, %xmm0
	movl	%ecx, %esi
	jmp	.LBB20_181
	.p2align	4, 0x90
.LBB20_179:                             # %if.then176
                                        #   in Loop: Header=BB20_181 Depth=1
	leal	(,%rdx,4), %ecx
	movq	$0, 24(%r9,%rcx,8)
	movb	$1, %cl
	movb	$1, %sil
.LBB20_180:                             # %for.inc183
                                        #   in Loop: Header=BB20_181 Depth=1
	incq	%rdx
	movq	prm(%rip), %rdi
	movslq	96(%rdi), %rdi
...
# %bb.182:                              # %if.then161
	...
	cmpl	$1, %ecx
	je	.LBB20_179
# %bb.183:                              #   in Loop: Header=BB20_181 Depth=1
	xorl	%ecx, %ecx
	xorl	%esi, %esi
	jmp	.LBB20_180
.LBB20_184:                             # %for.cond186.preheader.loopexit
	movzbl	%cl, %eax
	andl	$1, %eax
	addl	$3, %eax
...
.LBB20_193:                             # %for.end199
	...
	movsd	112(%rsp), %xmm7                # 8-byte Reload
                                        # xmm7 = mem[0],zero
	addsd	424(%rsp), %xmm7                # 8-byte Folded Reload
	addsd	416(%rsp), %xmm4                # 8-byte Folded Reload
	xorps	%xmm2, %xmm2
	cvtsi2sd	%eax, %xmm2
...
.LBB20_194:                             # %cdce.end
	...
	addsd	%xmm7, %xmm3
	addsd	%xmm4, %xmm3
	addsd	344(%rsp), %xmm3                # 8-byte Folded Reload
	addsd	352(%rsp), %xmm3                # 8-byte Folded Reload
	addsd	360(%rsp), %xmm3                # 8-byte Folded Reload
	addsd	16(%rsp), %xmm3                 # 8-byte Folded Reload
	addsd	%xmm0, %xmm3
	movl	(%r14), %edx
	testl	%edx, %edx
	movapd	%xmm6, %xmm1
...
.LBB20_197:                             # %if.then227
	...
	movsd	176(%rsp), %xmm1                # 8-byte Reload
                                        # xmm1 = mem[0],zero
.LBB20_198:                             # %if.end232thread-pre-split
	movl	(%r14), %edx
.LBB20_199:                             # %if.end232
	cmpl	$-1, %edx
	jne	.LBB20_201

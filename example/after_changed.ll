...
3:                                                ; preds = %7, %19, %9, %0
  ...
  %6 = load i32, ptr @d, align 4, !dbg !32, !tbaa !30
  br i1 %5, label %7, label %22, !dbg !28

7:                                                ; preds = %3
  %8 = icmp ne i32 %6, 0, !dbg !33
  br i1 %8, label %9, label %3, !dbg !35, !llvm.loop !36

9:                                                ; preds = %7
  %10 = load ptr, ptr %1, align 8, !dbg !39, !tbaa !24
  %11 = getelementptr inbounds i32, ptr %10, i64 0, !dbg !39
  %12 = load i32, ptr %11, align 4, !dbg !41, !tbaa !30
  %13 = add nsw i32 %12, 1, !dbg !41
  store i32 %13, ptr %11, align 4, !dbg !41, !tbaa !30
  store i32 0, ptr @d, align 4, !dbg !42, !tbaa !30
  %14 = load ptr, ptr %1, align 8, !dbg !43, !tbaa !24
  %15 = getelementptr inbounds i32, ptr %14, i64 0, !dbg !43
  %16 = load i32, ptr %15, align 4, !dbg !43, !tbaa !30
  %17 = load i32, ptr @g, align 4, !dbg !45, !tbaa !30
  %18 = icmp eq i32 %16, %17, !dbg !46
  br i1 %18, label %19, label %3, !dbg !47, !llvm.loop !36

19:                                               ; preds = %9
  %20 = load ptr, ptr %1, align 8, !dbg !48, !tbaa !24
  %21 = getelementptr inbounds i32, ptr %20, i64 0, !dbg !48
  store i32 0, ptr %21, align 4, !dbg !49, !tbaa !30
  br label %3, !dbg !48, !llvm.loop !36
...
!34 = distinct !DILexicalBlock(scope: !15, file: !3, line: 5, column: 9)
!35 = !DILocation(line: 5, column: 9, scope: !15)
!36 = distinct !{!36, !28, !37, !38}
!37 = !DILocation(line: 10, column: 5, scope: !15)
!38 = !{!"llvm.loop.mustprogress"}
!39 = !DILocation(line: 6, column: 7, scope: !40)
!40 = distinct !DILexicalBlock(scope: !34, file: !3, line: 5, column: 12)
!41 = !DILocation(line: 6, column: 11, scope: !40)
!42 = !DILocation(line: 7, column: 9, scope: !40)
!43 = !DILocation(line: 8, column: 11, scope: !44)
!44 = distinct !DILexicalBlock(scope: !40, file: !3, line: 8, column: 11)
!45 = !DILocation(line: 8, column: 19, scope: !44)
!46 = !DILocation(line: 8, column: 16, scope: !44)
!47 = !DILocation(line: 8, column: 11, scope: !40)
!48 = !DILocation(line: 9, column: 9, scope: !44)
!49 = !DILocation(line: 9, column: 14, scope: !44)

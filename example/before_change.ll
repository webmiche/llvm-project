...
define dso_local i32 @foo() local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %.not, label %final_block, label %.split.preheader, !dbg !26

.split.preheader:                                 ; preds = %0
  %2 = icmp eq i32 %d.promoted, 0, !dbg !27
  br label %.split, !dbg !26

.split:                                           ; preds = %.split.preheader, %core_block
  %.not3 = phi i1 [ true, %core_block ], [ %2, %.split.preheader ]
  br i1 %.not3, label %core_block, label %forward_block, !dbg !29

forward_block:                                                ; preds = %.split
  br label %core_block, !dbg !30

core_block:                                                ; preds = %forward_block, %.split

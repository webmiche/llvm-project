; ModuleID = 'implicit_preprocessed_changed.ll'
...
; Function Attrs: minsize mustprogress nofree nosync nounwind optsize sspstrong willreturn memory(read, argmem: none, inaccessiblemem: readwrite) uwtable
define dso_local i32 @foo() local_unnamed_addr #0 !dbg !15 {
  ...
  %.not = icmp eq i32 %1, 0
  tail call void @llvm.assume(i1 %.not), !dbg !26
  %d.promoted = load i32, ptr @d, align 4, !tbaa !22
  ret i32 %d.promoted, !dbg !27
}
...
attributes #0 = { minsize mustprogress nofree nosync nounwind optsize sspstrong willreturn memory(read, argmem: none, inaccessiblemem: readwrite) uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }

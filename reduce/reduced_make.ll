...
%struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211 = type { i32, [64 x i32], i64, i64, i64, [13 x i64], i32, i32, [13 x i32], i32, i32, i32, i32, i32, i32, i32, i64, i64, [64 x %struct.move_x.0.3.18.24.384.1062.1068.1092.1161.1287.3843.3861.3882.3888.3894.3918.3957.4149.4155.4164.4167.4173.4185.4188.4191.4197.4203.4209], [64 x i32], [64 x i32], [64 x %struct.anon.1.4.19.25.385.1063.1069.1093.1162.1288.3844.3862.3883.3889.3895.3919.3958.4150.4156.4165.4168.4174.4186.4189.4192.4198.4204.4210], i64, i64, i32, [64 x i32], i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [1000 x i64] }
%struct.move_x.0.3.18.24.384.1062.1068.1092.1161.1287.3843.3861.3882.3888.3894.3918.3957.4149.4155.4164.4167.4173.4185.4188.4191.4197.4203.4209 = type { i32, i32, i32, i32, i64, i64 }
%struct.anon.1.4.19.25.385.1063.1069.1093.1162.1288.3844.3862.3883.3889.3895.3919.3958.4150.4156.4165.4168.4174.4186.4189.4192.4198.4204.4210 = type { i32, i32, i32, i32 }
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %arrayidx28 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 1, i64 %idxprom27
  %9 = load i32, ptr %arrayidx28, align 4
  %add = add i32 %9, 1
  %shr29.mask = and i32 %add, -2
  %cmp = icmp eq i32 %shr29.mask, 2
  br i1 %cmp, label %if.then31, label %if.end34

if.then31:                                        ; preds = %if.end
  %fifty32 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 15
...
if.then58:                                        ; preds = %if.then50
  %WhitePieces = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 4
...
if.else121:                                       ; preds = %if.else92
  store i32 0, ptr %hash363, align 8
  br label %if.end145
...
if.end160:                                        ; preds = %if.end145, %if.then58, %if.then50
  ...
  %arrayidx163 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 1, i64 %idxprom162
  %10 = load i32, ptr %arrayidx163, align 4, !tbaa !6
  %11 = load i8, ptr getelementptr inbounds ([12 x [64 x i8]], ptr @psq_table, i64 0, i64 1), align 1
  ...
  %psq_score1847 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 7
  %add185 = or i32 %conv183, %5
  store i32 %add185, ptr %psq_score1847, align 4
  %add186 = add i32 %10, 1
  %cmp188 = icmp ult i32 %add186, 2
...
if.then360:                                       ; preds = %if.else358
  %hash36310 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 16
  ...
  %or.cond = or i1 %cmp376.not, %cmp57.not
  br i1 %or.cond, label %if.end384, label %if.then379
...
if.end384:                                        ; preds = %if.then379, %if.then360
  ...
  %psq_score393 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 7
...
if.end448:                                        ; preds = %if.then443, %if.else424
  %psq_score452 = getelementptr %struct.state_t.2.5.20.26.386.1064.1070.1094.1163.1289.3845.3863.3884.3890.3896.3920.3959.4151.4157.4166.4169.4175.4187.4190.4193.4199.4205.4211, ptr %s, i64 0, i32 7

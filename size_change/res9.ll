...
do.body:                                          ; preds = %do.cond, %if.end13
  %5 = load i64, ptr %in_pos, align 8, !tbaa !5
  ...
  %8 = load i64, ptr %vli_pos.addr.0, align 8, !tbaa !5
  %mul15 = mul i64 %8, 7
  %shl = shl i64 %conv14, %mul15
  %9 = load i64, ptr %vli, align 8, !tbaa !5
  %add = add i64 %shl, %9
  store i64 %add, ptr %vli, align 8, !tbaa !5
  %10 = load i64, ptr %vli_pos.addr.0, align 8, !tbaa !5
  %inc16 = add i64 %10, 1
  store i64 %inc16, ptr %vli_pos.addr.0, align 8, !tbaa !5
  %cmp19 = icmp sgt i8 %6, -1
...
do.cond:                                          ; preds = %cleanup
  %11 = load i64, ptr %in_pos, align 8, !tbaa !5
  %cmp36 = icmp ult i64 %11, %in_size

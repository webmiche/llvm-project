...
if.end5.lor.lhs.false_crit_edge:                  ; preds = %if.end5
  %.pre = load i64, ptr %vli, align 8, !tbaa !5
  br label %lor.lhs.false
...
if.end9:                                          ; preds = %lor.lhs.false
  %3 = load i64, ptr %in_pos, align 8, !tbaa !5
...
if.end13:                                         ; preds = %if.end9, %if.then
  ...
  %4 = add nuw i64 %in_pos.promoted, 1
  %umax = tail call i64 @llvm.umax.i64(i64 %in_size, i64 %4)
  br label %do.body

do.body:                                          ; preds = %do.cond, %if.end13
  %add36 = phi i64 [ %vli.promoted, %if.end13 ], [ %add, %do.cond ]
  %inc1632 = phi i64 [ %vli_pos.addr.0.promoted, %if.end13 ], [ %inc16, %do.cond ]
  %5 = phi i64 [ %in_pos.promoted, %if.end13 ], [ %inc, %do.cond ]
  %arrayidx = getelementptr inbounds i8, ptr %in, i64 %5
  %6 = load i8, ptr %arrayidx, align 1, !tbaa !9
  %inc = add nuw i64 %5, 1
  %7 = and i8 %6, 127
  %conv14 = zext i8 %7 to i64
  %mul15 = mul i64 %inc1632, 7
  %shl = shl i64 %conv14, %mul15
  %add = add i64 %shl, %add36
  %inc16 = add i64 %inc1632, 1

...
do.body:                                          ; preds = %do.cond, %if.end13
  ...
  %9 = load i64, ptr %vli_pos.addr.0, align 8, !tbaa !5
  %mul15 = mul i64 %9, 7
  %shl = shl i64 %conv14, %mul15
  %10 = load i64, ptr %vli, align 8, !tbaa !5
  %add = add i64 %shl, %10
...
do.cond:                                          ; preds = %cleanup
  %12 = load i64, ptr %in_pos, align 8, !tbaa !5
  %cmp36 = icmp ult i64 %12, %in_size
